...
public class WriteData {
    ...
    public void writeArrays() throws Exception {
        File file_input = new File("C:\\Users\\user\\Documents\\Учеба\\Семестр 2\\Параллельные вычисления\\parallel\\src\\main\\resources", "test_input.txt");
        ...
        File file_output = new File("C:\\Users\\user\\Documents\\Учеба\\Семестр 2\\Параллельные вычисления\\parallel\\src\\main\\resources", "test_output.txt");
